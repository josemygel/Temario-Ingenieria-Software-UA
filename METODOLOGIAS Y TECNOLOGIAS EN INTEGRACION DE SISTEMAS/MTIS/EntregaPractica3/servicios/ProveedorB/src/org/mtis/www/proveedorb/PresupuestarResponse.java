 ...
 */
            ...
            /**
            *  PresupuestarResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PresupuestarResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.mtis.org/ProveedorB/",
                "presupuestarResponse",
                "ns1");
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://www.mtis.org/ProveedorB/");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":presupuestarResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "presupuestarResponse",
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://www.mtis.org/ProveedorB/")){
                return "ns1";
            }
    ...
    public static class Factory{
        ...
        */
        public static PresupuestarResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PresupuestarResponse object =
                new PresupuestarResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"presupuestarResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PresupuestarResponse)org.mtis.www.proveedorb.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

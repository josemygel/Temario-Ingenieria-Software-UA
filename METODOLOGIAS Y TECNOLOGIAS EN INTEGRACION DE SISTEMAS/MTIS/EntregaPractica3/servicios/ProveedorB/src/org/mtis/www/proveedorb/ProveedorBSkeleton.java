 ...
 */
public class ProveedorBSkeleton {
	...
	public org.mtis.www.proveedorb.PresupuestarResponse presupuestar(org.mtis.www.proveedorb.Presupuestar presupuestar) {
		final String ref = presupuestar.getReferencia();
		final int cantidad = presupuestar.getUnidades();

		ProveedorBLogicDAO dao = new ProveedorBLogicDAO();
		PresupuestarResponse resp = new PresupuestarResponse();
		resp.setResultado(false);
		resp.setPrecio(-1);

		System.out.println("\n==========================================\n");
		System.out.println("ProveedorB [INFO]: La empresa solicita presupuesto para el producto(" + ref
		...
		System.out.println("ProveedorB [" + (resp.getResultado() ? "INFO" : "ERROR") + "]: " + resp.getMensaje());
	...
	public org.mtis.www.proveedorb.SolicitarResponse solicitar(org.mtis.www.proveedorb.Solicitar solicitar) {
		...
		ProveedorBLogicDAO dao = new ProveedorBLogicDAO();
		System.out.println("\n==========================================\n");
		System.out.println("ProveedorB [INFO]: La empresa solicita stock de producto(" + ref + ") por "
				+ cantidad + " unidades");
